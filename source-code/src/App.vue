<template>
  <div>
    <v-app>
      <v-app-bar app clipped-right max-height="90px">
        ...
        <div v-show="!mobile">
          ...
          <v-btn text :to="{ name: 'about' }"
            ><v-icon :color="themeColor">mdi-clipboard-text</v-icon>
            About</v-btn
          >

          <v-menu open-on-hover bottom offset-y>
            <template v-slot:activator="{ on, attrs }">
              <v-btn text :to="{ name: 'products' }" v-bind="attrs" v-on="on">
      ...
      <v-footer outlined>
        <div class="mx-auto">
          <div>
            <b
              >Copyright &copy; {{ new Date().getFullYear() }} AgroSavvy. All
              rights reserved.</b
            >
          </div>
          <div>
